<?php
    ...
    $edit = $_GET['edit'];
    $sql = "select * from queryapplication where id = '$edit'";
    ...
    if(isset($_POST['Submit']))
        {
            ...
            $sql = "update queryapplication set name='$name',mobile ='$mobile',email='$email',query='$query' where id = '$edit' ";
            ...
            <div class="col-md-9">
                ...
                <form action="add.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="query" class="form-control" placeholder="Enter your Query" value="<?php echo $query; ?>">
                    </div>
                    <br/>
